import { f as f$1, j, x, w, i as i$3, T } from './directive-helpers-B3SPnMX6.js';
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const e={},i$1=e$1(class extends i$2{constructor(){super(...arguments),this.ot=e;}render(r,t){return t()}update(t,[s,e]){if(Array.isArray(s)){if(Array.isArray(this.ot)&&this.ot.length===s.length&&s.every(((r,t)=>r===this.ot[t])))return w}else if(this.ot===s)return w;return this.ot=Array.isArray(s)?Array.from(s):s,this.render(s,e)}});
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n=t=>!i$3(t)&&"function"==typeof t.then,h=1073741823;class c extends f{constructor(){super(...arguments),this._$Cwt=h,this._$Cbt=[],this._$CK=new s(this),this._$CX=new i;}render(...s){return s.find((t=>!n(t)))??w}update(s,i){const e=this._$Cbt;let r=e.length;this._$Cbt=i;const o=this._$CK,c=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<i.length&&!(t>this._$Cwt);t++){const s=i[t];if(!n(s))return this._$Cwt=t,s;t<r&&s===e[t]||(this._$Cwt=h,r=0,Promise.resolve(s).then((async t=>{for(;c.get();)await c.get();const i=o.deref();if(void 0!==i){const e=i._$Cbt.indexOf(s);e>-1&&e<i._$Cwt&&(i._$Cwt=e,i.setValue(t));}})));}return w}disconnected(){this._$CK.disconnect(),this._$CX.pause();}reconnected(){this._$CK.reconnect(this),this._$CX.resume();}}const m=e$1(c);
...
const Router$1 = (host) => {
  ...
  return i$1([result], () => m(Promise.resolve(result).catch(() => T), T));
};
...
customElements.define(
  ...
  component(() => {
    const routes = [
      {
        rule: hashbang(/^\/$/u),
        handle: () => import('./home-BebNeLQk.js').then(() => createElement("demo-home"))
      },
      {
        rule: hashbang(/^\/view-1/u),
        handle: () => import('./view-1-Bb4KmWUq.js').then(() => createElement("view-1"))
      },
      {
        rule: hashbang(/^\/view-2/u),
        handle: () => import('./view-2-WbOEJ6Nc.js').then(() => createElement("view-2"))
      },
      {
        rule: hashbang(/^\/view-3/u),
        handle: () => import('./view-3-BFAQNp-M.js').then(() => createElement("view-3"))
      }
    ];
