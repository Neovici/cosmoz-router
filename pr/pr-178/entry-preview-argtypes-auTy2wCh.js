...
import './directive-helpers-DdoUbUQq.js';
import './index-DY4It86c.js';

var{window:globalWindow}=__STORYBOOK_MODULE_GLOBAL__.global;globalWindow.STORYBOOK_ENV="web-components";function isValidComponent(tagName){if(!tagName)return false;if(typeof tagName=="string")return true;throw new Error('Provided component needs to be a string. e.g. component: "my-element"')}function isValidMetaData(customElements){if(!customElements)return false;if(customElements.tags&&Array.isArray(customElements.tags)||customElements.modules&&Array.isArray(customElements.modules))return true;throw new Error(`You need to setup valid meta data in your config.js via setCustomElements().
    ...
    function ee({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: o }) {
      return /* @__PURE__ */ r(function(l, f, d) {
        ...
        if (!(h === "." && D !== "<" || h === "[" && (e || d.type === "JsdocTypeName") || t && (h === "~" || h === "#")))
          return null;
        let O, ae = false;
        l.consume(".") ? O = "property" : l.consume("[") ? (O = "property-brackets", ae = true) : l.consume("~") ? O = "inner" : (l.consume("#"),
        O = "instance");
        ...
        parsePrefix: /* @__PURE__ */ r((o) => {
          ...
          if (!o.consume("}")) {
            ...
            for (; ; ) {
              ...
              let h = false;
              if (d.type === "JsdocTypeNullable" && (h = true, d = d.element), d.type === "JsdocTypeNumber" || d.type === "JsdocTypeName" || d.
              type === "JsdocTypeStringValue") {
                let E;
    ...
    function Oe({ allowOptional: e, allowVariadic: t }) {
      return x({
        ...
        parseInfix: /* @__PURE__ */ r((o, i) => {
          let l = false, f = false;
          if (e && i.type === "JsdocTypeNullable" && (l = true, i = i.element), t && i.type === "JsdocTypeVariadic" && i.element !== void 0 &&
          (f = true, i = i.element), i.type !== "JsdocTypeName")
            throw new c(i);
          o.consume(":");
...
TypeObject"),
    ...
    let pr = {
      ...
      JsdocTypeSymbol: /* @__PURE__ */ r((e) => {
        ...
        return o?.type === "JsdocTypeVariadic" && (o.meta.position === "prefix" ? t = "..." : i = true, o = o.element), o?.type === "JsdocType\
Name" ? t += o.value : o?.type === "JsdocTypeNumber" && (t += o.value.toString()), i && (t += "..."), F(`${e.value}(${t})`);
    ...
    let ur = {
      ...
      JsdocTypeNamePath: /* @__PURE__ */ r((e, t) => {
        let o = false, i, l;
        e.right.type === "JsdocTypeSpecialNamePath" && e.right.specialType === "event" ? (o = true, i = e.right.value, l = V(e.right.meta.quote)) :
