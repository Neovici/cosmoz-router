import { f as f$1, j, x, w, i as i$3, T } from './directive-helpers-C5sW89lv.js';
...
customElements.define(
  ...
  component(() => {
    const routes = [
      {
        rule: hashbang(/^\/$/u),
        handle: () => import('./home-BKjtk6Zg.js').then(() => createElement("demo-home"))
      },
      {
        rule: hashbang(/^\/view-1/u),
        handle: () => import('./view-1-DAIWSops.js').then(() => createElement("view-1"))
      },
      {
        rule: hashbang(/^\/view-2/u),
        handle: () => import('./view-2-4VYcU9O_.js').then(() => createElement("view-2"))
      },
      {
        rule: hashbang(/^\/view-3/u),
        handle: () => import('./view-3-X06jxRRl.js').then(() => createElement("view-3"))
      }
    ];
